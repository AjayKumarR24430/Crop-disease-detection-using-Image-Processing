...
img2=cv2.imread("C:/Users/HP/Desktop/potatoheal.jpg")
cv2.waitKey(0)
...
while( not done):
    ...
    for i in range(a):
        ...
        x2 = int(x0 - 1000*(-b))
        y2 = int(y0 - 1000*(a))
        cv2.line(img1,(x1,y1),(x2,y2),(0,0,255),2, cv2.LINE_AA)
#showing the results:
plt.subplot(121)
#OpenCV reads images as BGR, this corrects so it is displayed as RGB
plt.plot(),plt.imshow(cv2.cvtColor(img1, cv2.COLOR_BGR2RGB)) 
